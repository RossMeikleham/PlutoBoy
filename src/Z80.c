...
licensee licenses[] = {{0, "none"}, {1, "nintendo"}, {8, "capcom"}, {13, "electronic arts"}, {18, "hudsonsoft"}, {19, "b-ai"},
     ...
     {30, "viacom"}, {31, "nintendo"}, {32, "bandia"}, {33, "ocean/acclaim"}, {34, "konami"}, {35, "hector"}, {37, "taito"},
     ...
     {52, "american sammy"}, {54, "konami"}, {55, "hi tech entertainment"}, {56, "ljn"}}; 


rom_size rom_sizes[] = {{0x0, 32}, {0x1, 64}, {0x2, 128}, {0x3, 256}, {0x4, 512},
    {0x5, 1024}, {0x6, 2048}, {0x7, 4096}, {0x52, 1152}, {0x53, 1280}, {0x54, 1536}};

cartridge_type cartridge_types[] = {{0x00 ,"ROM"}, {0x01, "MBC1"},
 {.id = 0x02, "MBC1+RAM"}, {0x03, "MBC1+RAM+BATTERY"}, {0x05, "MBC2"}, 
 {0x06, "MBC2+BATTERY"}, {0x08, "ROM+RAM"},
    {0x09, "ROM+RAM+BATTERY"}, {0x0B, "MMM01"}, {0x0C, "MMM01+RAM"}, {0x0D, "MMM01+RAM+BATTERY"},
...
/*  Returns pointer to liscensee from supplied hex id,
 *  Returns NULL if unknown id supplied */
...
int has_sgb_features() {
    return mem[GB_FUNCTION];
}

int is_colour_compatible() {
    return !!mem[IS_COLOUR_COMPATIBLE];
}
