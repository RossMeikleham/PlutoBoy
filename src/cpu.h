...
/*  Function Jump table of all 255 one byte instructions  */
    ...
    /*x(0/8)        x(1/9)      x(2/A)    x(3/B)      x(4/C)      x(5/D)       x(6/E)      x(7/F)*/
/*0x*/NOP,        LD_BC_IM,   LD_memBC_A, INC_BC,     INC_B,      DEC_B,      LD_B_IM,     RLC_A, 
      LD_nn_SP,   ADD_HL_BC,  LD_A_memBC, DEC_BC,     INC_C,      DEC_C,      LD_C_IM,     RRC_A, 

/*1x*/STOP,       LD_DE_IM,   LD_memDE_A, INC_DE,     INC_D,      DEC_D,      LD_D_IM,     RL_A,          
      JR_n,       ADD_HL_DE,  LD_A_memDE, DEC_DE,     INC_E,      DEC_E,      LD_E_IM,     RR_A, 

/*2x*/JR_NZ_n,    LD_HL_IM,   LDI_HL_A,   INC_HL,     INC_H,      DEC_H,      LD_H_IM,     DAA, 
      JR_Z_n,     ADD_HL_HL,  LDI_A_HL,   DEC_HL,     INC_L,      DEC_L,      LD_L_IM,     CPL, 

/*3x*/JR_NC_n,    LD_SP_IM,   LDD_HL_A,   INC_SP,     INC_memHL,  DEC_memHL,  LD_HL_n,     SCF,
      JR_C_n,     ADD_HL_SP,  LDD_A_HL,   DEC_SP,     INC_A,      DEC_A,      LD_A_IM,     CCF,
      
/*4x*/LD_B_B,     LD_B_C,     LD_B_D,     LD_B_E,     LD_B_H,     LD_B_L,     LD_B_memHL,  LD_B_A,
      LD_C_B,     LD_C_C,     LD_C_D,     LD_C_E,     LD_C_H,     LD_C_L,     LD_C_memHL,  LD_C_A,

/*5x*/LD_D_B,     LD_D_C,     LD_D_D,     LD_D_E,     LD_D_H,     LD_D_L,     LD_D_memHL,  LD_D_A,
      LD_E_B,     LD_E_C,     LD_E_D,     LD_E_E,     LD_E_H,     LD_E_L,     LD_E_memHL,  LD_E_A,
 
/*6x*/LD_H_B,     LD_H_C,     LD_H_D,     LD_H_E,     LD_H_H,     LD_H_L,     LD_H_memHL,  LD_H_A,
      LD_L_B,     LD_L_C,     LD_L_D,     LD_L_E,     LD_L_H,     LD_L_L,     LD_L_memHL,  LD_L_A,

/*7x*/LD_memHL_B, LD_memHL_C, LD_memHL_D, LD_memHL_E, LD_memHL_H, LD_memHL_L, HALT,        LD_memHL_A,
      LD_A_B,     LD_A_C,     LD_A_D,     LD_A_E,     LD_A_H,     LD_A_L,     LD_A_memHL,  LD_A_A,

/*8x*/ADD_A_B,    ADD_A_C,    ADD_A_D,    ADD_A_E,    ADD_A_H,    ADD_A_L,    ADD_A_memHL, ADD_A_A,
      ADC_A_B,    ADC_A_C,    ADC_A_D,    ADC_A_E,    ADC_A_H,    ADC_A_L,    ADC_A_memHL, ADC_A_A,

/*9x*/SUB_A_B,    SUB_A_C,    SUB_A_D,    SUB_A_E,    SUB_A_H,    SUB_A_L,    SUB_A_memHL, SUB_A_A,
      SBC_A_B,    SBC_A_C,    SBC_A_D,    SBC_A_E,    SBC_A_H,    SBC_A_L,    SBC_A_memHL, SBC_A_A,

/*Ax*/AND_A_B,    AND_A_C,    AND_A_D,    AND_A_E,    AND_A_H,    AND_A_L,    AND_A_memHL, AND_A_A,
      XOR_A_B,    XOR_A_C,    XOR_A_D,    XOR_A_E,    XOR_A_H,    XOR_A_L,    XOR_A_memHL, XOR_A_A,
      
/*Bx*/OR_A_B,     OR_A_C,     OR_A_D,     OR_A_E,     OR_A_H,     OR_A_L,     OR_A_memHL,  OR_A_A,
      CP_A_B,     CP_A_C,     CP_A_D,     CP_A_E,     CP_A_H,     CP_A_L,     CP_A_memHL,  CP_A_A,

/*Cx*/RET_NZ,     POP_BC,     JP_NZ_nn,   JP_nn,      CALL_NZ_nn, PUSH_BC,    ADD_A_Im8,   RST_00,
      RET_Z,      RET,        JP_Z_nn,    NULL,       CALL_Z_nn,  CALL_nn,    ADC_A_Im8,   RST_08,

/*Dx*/RET_NC,     POP_DE,     JP_NC_nn,   NULL,       CALL_NC_nn, PUSH_DE,    SUB_A_Im8,   RST_10,
      RET_C,      RETI,       JP_C_nn,    NULL,       CALL_C_nn,  NULL,       SBC_A_Im8,   RST_18,

/*Ex*/LDH_n_A,    POP_HL,     LDH_C_A,    NULL,       NULL,       PUSH_HL,    AND_A_Im8,   RST_20,
      ADD_SP_IM8, JP_memHL,   LD_memnn_A, NULL,       NULL,       NULL,       XOR_A_Im8,   RST_28,

/*Fx*/LDH_A_n,    POP_AF,     LDH_A_C,    DI,         NULL,       PUSH_AF,    OR_A_Im8,    RST_30,
